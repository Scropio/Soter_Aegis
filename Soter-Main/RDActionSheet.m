...
- (void)setupTitle {
    ...
    self.titleLabel.frame = CGRectMake((self.bounds.size.width - labelWidth) / 2, self.titleLabel.frame.origin.y - 5, labelWidth, self.titleLabel.bounds.size.height + 10);
...
//    Oringinal
//    UIImage *backgroundImage = [[UIImage imageNamed:@"SheetButtonDismiss.png"]
//                                stretchableImageWithLeftCapWidth:9
//                                topCapHeight:1];
//    [button setBackgroundImage:backgroundImage forState:UIControlStateNormal];
//    
//    UIImage *touchBackgroundImage = [[UIImage imageNamed:@"SheetButtonDismissTouch.png"]
//                                     stretchableImageWithLeftCapWidth:9
//                                     topCapHeight:1];
//    [button setBackgroundImage:touchBackgroundImage forState:UIControlStateHighlighted];    
